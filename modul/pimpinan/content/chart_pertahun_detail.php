...
<ul class="breadcrumb">
    ...
    <li><a href="index.php?content=chart_pertahun">Chart Penerimaan PAD Pertahun</a></li>
...
<h4 align="center">CHART JUMLAH PENDAPATAN RETRIBUSI PASAR</h4>
...
<div style="margin-left:10px">
  <a href="index.php?content=chart_pertahun"><button class="btn btn-success">Kembali</button></a>
</div>
<br/>
