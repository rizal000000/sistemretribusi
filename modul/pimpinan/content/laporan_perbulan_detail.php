...
<ul class="breadcrumb">
    ...
    <li><a href="index.php?content=laporan_perbulan">Laporan Penerimaan PAD Perbulan</a></li>
...
<h4 align="center">DAFTAR REKAP REALISASI PENERIMAAN PAD BULAN <?php echo strtoupper($main->change_date($_POST['bulan'])); ?></h4>
...
<table id="example" border="1" class="table table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%">
  <tr>
    ...
    <td colspan="2" valign="center" align="center"><b>JUMLAH REALISASI PENERIMAAN PERBULAN</b></td>
  </tr>
  <tr>
...
<div style="margin-left:10px">
  <a href="index.php?content=laporan_perbulan"><button class="btn btn-success">Kembali</button></a>
</div>
<br/>
