...
?>
              ...
              <div align="right" style="margin-right:10px">
                <a href="index.php?content=i<?php echo $link; ?>"><button class="btn btn-primary"><i class="icon-plus-sign"></i> Input Pasar Baru</button></a>
              </div><br/>
...
?>
        ...
        <thead>
           <tr>
            ...
            <th rowspan="1" colspan="1">Jumlah Los</th>
            <th rowspan="1" colspan="1">Jumlah Kios</th>
            ...
            while($d=mysql_fetch_assoc($q)){
                  ...
                  echo "
                            <tr role='row' class='odd'>
                              ...
                              <td width='40%'>".ucfirst($d['alamat'])."</td>
                              <td>".ucfirst($d['jumlah_los'])."</td>
                              <td>".ucfirst($d['jumlah_kios'])."</td>
                              <td>
