...
// /get link
	...
	// $jenis="listening";
		...
		$check=mysql_fetch_assoc(mysql_query("SELECT * FROM p_tarif"));
...
$process=$crud->edit6($table,'t_los','t_kios','t_kakilima','t_kebersihan_los','t_kebersihan_kios','t_kebersihan_kakilima',$id,$t_los,$t_kios,$t_kakilima,$t_kebersihan_los,$t_kebersihan_kios,$t_kebersihan_kakilima);
			// } else {
