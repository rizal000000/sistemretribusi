...
// /get link
	...
	$hak_pedagang=mysql_fetch_assoc(mysql_query("SELECT * FROM p_hakpedagang WHERE id_pedagang='$id_pedagang'"));
	$jenis=$_POST['jenis'];
...
$process=$crud->add6($table,$id_pedagang,$hak_pedagang['id_pasar'],$jenis,$pembayaran_ke,$tgl,$ket);
			// } else {
